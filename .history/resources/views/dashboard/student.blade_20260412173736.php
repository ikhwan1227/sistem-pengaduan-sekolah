    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <div class="bg-gradient-to-br from-purple-50 via-indigo-50 to-blue-50 dark:from-purple-900/30 dark:via-indigo-900/30 dark:to-blue-900/30 rounded-xl shadow-sm border border-purple-200 dark:border-purple-800 overflow-hidden">
            ...
            <div class="p-4" x-data="tipsSlider()" x-init="initSlider()">
                ...
                <!-- Tombol Prev/Next -->
                <button @click="prev()" class="absolute left-0 top-1/2 -translate-y-1/2 -ml-2 w-7 h-7 bg-white dark:bg-gray-800 rounded-full shadow-md flex items-center justify-center hover:bg-purple-50 dark:hover:bg-purple-900/30 transition border border-purple-200 dark:border-purple-700">
                    <svg class="w-3.5 h-3.5 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                    </svg>
                </button>
                <button @click="next()" class="absolute right-0 top-1/2 -translate-y-1/2 -mr-2 w-7 h-7 bg-white dark:bg-gray-800 rounded-full shadow-md flex items-center justify-center hover:bg-purple-50 dark:hover:bg-purple-900/30 transition border border-purple-200 dark:border-purple-700">
                    <svg class="w-3.5 h-3.5 text-purple-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
