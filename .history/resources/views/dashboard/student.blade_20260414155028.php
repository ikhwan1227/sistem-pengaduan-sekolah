...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="dashboard-layout">
        ...
        <div class="dashboard-col" x-data="studentTipsSlider" x-init="initSlider()">
                        ...
                        <div class="flex items-center gap-2">
                            <template x-for="(tip, index) in tips" :key="index">
                                <button @click="currentIndex = index" 
                                        ...
                                        :class="currentIndex === index ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'">
                                </button>
                            </template>
                        </div>
...
<script>
    ...
    // Register ke Alpine.js (pastikan Alpine sudah terload)
    if (typeof Alpine !== 'undefined') {
        Alpine.data('studentTipsSlider', studentTipsSlider);
    }
</script>
@endsection