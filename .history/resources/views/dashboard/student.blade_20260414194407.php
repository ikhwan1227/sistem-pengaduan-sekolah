...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="flex flex-col lg:flex-row gap-4">
        {{-- Pesan Sambutan (mengambil sisa ruang, tapi tidak terlalu lebar) --}}
        <div class="flex-1 min-w-0">
            <div class="bg-white dark:bg-gray-800 rounded-xl p-4 md:p-5 border border-gray-200 dark:border-gray-700 shadow-sm">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        <h2 class="text-base md:text-lg font-semibold text-gray-800 dark:text-white truncate">
        ...
        {{-- Quick Action (lebar menyesuaikan konten) --}}
            ...
            <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl p-3 md:p-4 shadow-md h-full">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('complaint.history') }}" class="px-3 py-1.5 bg-black/10 dark:bg-white/20 hover:bg-black/20 dark:hover:bg-white/30 rounded-lg text-gray-800 dark:text-white text-xs font-medium transition-all duration-200 flex items-center gap-1 whitespace-nowrap">
                            <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="dashboard-layout">
        ...
        <div class="dashboard-col" x-data="{
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.2)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.3)] transition-all duration-300 border border-indigo-200 dark:border-indigo-800 overflow-hidden flex flex-col h-full">
                ...
                {{-- Dots Navigation MANUAL (8 dots) - Support Dark Mode dengan outline --}}
<div class="flex items-center gap-2">
    <button @click="goToSlide(0)" 
            class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
            :class="currentIndex === 0 ? 'w-6 bg-blue-600 shadow-sm ring-2 ring-white/50' : 'w-2.5 bg-white/80 dark:bg-white/60 hover:bg-white ring-1 ring-gray-300 dark:ring-gray-600'">
    </button>
    <button @click="goToSlide(1)" 
            class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
            :class="currentIndex === 1 ? 'w-6 bg-blue-600 shadow-sm ring-2 ring-white/50' : 'w-2.5 bg-white/80 dark:bg-white/60 hover:bg-white ring-1 ring-gray-300 dark:ring-gray-600'">
    </button>
    <button @click="goToSlide(2)" 
            class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
            :class="currentIndex === 2 ? 'w-6 bg-blue-600 shadow-sm ring-2 ring-white/50' : 'w-2.5 bg-white/80 dark:bg-white/60 hover:bg-white ring-1 ring-gray-300 dark:ring-gray-600'">
    </button>
    <button @click="goToSlide(3)" 
            class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
            :class="currentIndex === 3 ? 'w-6 bg-blue-600 shadow-sm ring-2 ring-white/50' : 'w-2.5 bg-white/80 dark:bg-white/60 hover:bg-white ring-1 ring-gray-300 dark:ring-gray-600'">
    </button>
    <button @click="goToSlide(4)" 
            class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
            :class="currentIndex === 4 ? 'w-6 bg-blue-600 shadow-sm ring-2 ring-white/50' : 'w-2.5 bg-white/80 dark:bg-white/60 hover:bg-white ring-1 ring-gray-300 dark:ring-gray-600'">
    </button>
    <button @click="goToSlide(5)" 
            class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
            :class="currentIndex === 5 ? 'w-6 bg-blue-600 shadow-sm ring-2 ring-white/50' : 'w-2.5 bg-white/80 dark:bg-white/60 hover:bg-white ring-1 ring-gray-300 dark:ring-gray-600'">
    </button>
    <button @click="goToSlide(6)" 
            class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
            :class="currentIndex === 6 ? 'w-6 bg-blue-600 shadow-sm ring-2 ring-white/50' : 'w-2.5 bg-white/80 dark:bg-white/60 hover:bg-white ring-1 ring-gray-300 dark:ring-gray-600'">
    </button>
    <button @click="goToSlide(7)" 
            class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
            :class="currentIndex === 7 ? 'w-6 bg-blue-600 shadow-sm ring-2 ring-white/50' : 'w-2.5 bg-white/80 dark:bg-white/60 hover:bg-white ring-1 ring-gray-300 dark:ring-gray-600'">
    </button>
</div>
            </div>
        </div>
