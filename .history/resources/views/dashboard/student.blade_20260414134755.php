...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    {{-- Menggunakan grid dengan lebar yang konsisten --}}
    <div class="grid grid-cols-2 gap-6">
        
        {{-- KIRI: Tips & Panduan (lebar akan mengikuti grid) --}}
        <div>
    ...
    {{-- Menggunakan grid dengan lebar yang SAMA PERSIS seperti section 1 --}}
    <div class="grid grid-cols-2 gap-6">
        
        {{-- KIRI: Quick Action + Progress (lebar akan mengikuti grid, SAMA dengan Tips & Panduan di atas) --}}
