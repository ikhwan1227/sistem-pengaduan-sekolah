...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        {{-- KANAN: Stats Card (menggunakan grid 2x3 agar rapi dan tidak melebar) --}}
        <div class="w-full md:w-1/2">
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3 h-full">
                ...
                <!-- Placeholder kosong untuk menjaga grid tetap rapi -->
    ...
    <div class="flex flex-col md:flex-row gap-6">
        ...
        {{-- KIRI: Quick Action dan Progress & Timeline --}}
