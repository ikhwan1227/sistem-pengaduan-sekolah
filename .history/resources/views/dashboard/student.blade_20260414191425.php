...
<div class="flex flex-col lg:flex-row gap-4">
    ...
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl px-2 py-2 shadow-md h-full">
        <div class="flex items-center justify-between gap-1">
            <div class="flex items-center gap-1">
                <svg class="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span class="text-white font-medium text-[11px]">Aksi</span>
            </div>
            <div class="flex gap-1">
                <a href="{{ route('complaint.index') }}" class="px-1.5 py-1 bg-white/20 hover:bg-white/30 rounded-md text-white text-[11px] font-medium transition-all duration-200" title="Buat">
                    Buat
                </a>
                <a href="{{ route('complaint.history') }}" class="px-1.5 py-1 bg-white/20 hover:bg-white/30 rounded-md text-white text-[11px] font-medium transition-all duration-200" title="Histori">
                    Histori
                </a>
                <a href="{{ route('student.tips') }}" class="px-1.5 py-1 bg-white/20 hover:bg-white/30 rounded-md text-white text-[11px] font-medium transition-all duration-200" title="Tips">
                    Tips
                </a>
            </div>
        </div>
