...
<div class="dashboard-col" x-data="{
    ...
    intervalId: null,
    initSlider() {
        console.log('Init slider, tips count:', this.tips.length);
        this.startAutoSlide();
    },
    next() {
    ...
    <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.2)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.3)] transition-all duration-300 border border-indigo-200 dark:border-indigo-800 overflow-hidden flex flex-col h-full">
        ...
        {{-- Footer SEDERHANA - Tanpa panah dulu --}}
        <div class="px-5 py-3 border-t border-indigo-200 dark:border-indigo-800 transition-colors duration-300" :style="'background-color: ' + getFooterBgColor(currentIndex)">
            <div class="flex items-center justify-center gap-2">
                <!-- Loop manual untuk debug -->
                <div class="w-2 h-2 rounded-full bg-white" :class="currentIndex === 0 ? 'w-6 bg-[#2563eb]' : ''"></div>
                <div class="w-2 h-2 rounded-full bg-white" :class="currentIndex === 1 ? 'w-6 bg-[#2563eb]' : ''"></div>
                <div class="w-2 h-2 rounded-full bg-white" :class="currentIndex === 2 ? 'w-6 bg-[#2563eb]' : ''"></div>
                <div class="w-2 h-2 rounded-full bg-white" :class="currentIndex === 3 ? 'w-6 bg-[#2563eb]' : ''"></div>
                <div class="w-2 h-2 rounded-full bg-white" :class="currentIndex === 4 ? 'w-6 bg-[#2563eb]' : ''"></div>
                <div class="w-2 h-2 rounded-full bg-white" :class="currentIndex === 5 ? 'w-6 bg-[#2563eb]' : ''"></div>
                <div class="w-2 h-2 rounded-full bg-white" :class="currentIndex === 6 ? 'w-6 bg-[#2563eb]' : ''"></div>
                <div class="w-2 h-2 rounded-full bg-white" :class="currentIndex === 7 ? 'w-6 bg-[#2563eb]' : ''"></div>
            </div>
        </div>
    </div>
</div>
