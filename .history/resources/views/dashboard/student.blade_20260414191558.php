...
<div class="flex flex-col lg:flex-row gap-4">
    {{-- Pesan Sambutan (lebih lebar dengan flex-grow) --}}
    <div class="flex-grow flex-shrink-0 basis-auto">
    ...
    {{-- Quick Action (ukuran tetap) --}}
    <div class="flex-shrink-0">
        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl p-3 md:p-4 shadow-md h-full flex items-center gap-3">
            <div class="flex items-center gap-2">
                <svg class="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span class="text-white font-medium text-sm hidden sm:inline">Aksi Cepat</span>
            </div>
