...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {{-- KIRI: Tips & Panduan --}}
        <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.2)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.3)] transition-all duration-300 border border-indigo-200 dark:border-indigo-800 overflow-hidden h-full">
        ...
        {{-- KANAN: Stats Cards (5 kartu statistik dengan grid 2x3 agar rapi) --}}
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-[0_4px_20px_rgba(37,99,235,0.1)] border border-gray-200 dark:border-gray-700 p-4 h-full">
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <!-- Total -->
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-950/40 dark:to-blue-900/30 rounded-xl p-3 transition-all duration-300 hover:shadow-md">
                    <div class="flex items-center justify-between">
                        <div>
                        ...
                        <div class="w-8 h-8 bg-blue-200 dark:bg-blue-800/50 rounded-lg flex items-center justify-center">
                ...
                <!-- Bulan Ini -->
                <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-950/40 dark:to-green-900/30 rounded-xl p-3 transition-all duration-300 hover:shadow-md">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wide">Bulan Ini</p>
                            <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $totalBulanIni }}</p>
                        </div>
                        <div class="w-8 h-8 bg-green-200 dark:bg-green-800/50 rounded-lg flex items-center justify-center">
                ...
                <!-- Selesai -->
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950/40 dark:to-emerald-900/30 rounded-xl p-3 transition-all duration-300 hover:shadow-md">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wide">Selesai</p>
                            <p class="text-2xl font-bold text-green-600 dark:text-green-400">{{ $selesai }}</p>
                        </div>
                        <div class="w-8 h-8 bg-emerald-200 dark:bg-emerald-800/50 rounded-lg flex items-center justify-center">
                ...
                <!-- Diproses -->
                <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-950/40 dark:to-yellow-900/30 rounded-xl p-3 transition-all duration-300 hover:shadow-md">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wide">Diproses</p>
                            <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400">{{ $diproses }}</p>
                        </div>
                        <div class="w-8 h-8 bg-yellow-200 dark:bg-yellow-800/50 rounded-lg flex items-center justify-center">
                ...
                <!-- Ditolak -->
                <div class="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950/40 dark:to-red-900/30 rounded-xl p-3 transition-all duration-300 hover:shadow-md">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-wide">Ditolak</p>
                            <p class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $ditolak }}</p>
                        </div>
                        <div class="w-8 h-8 bg-red-200 dark:bg-red-800/50 rounded-lg flex items-center justify-center">
                ...
                <!-- Placeholder kosong untuk menjaga grid tetap rapi (opsional) -->
                <div class="hidden sm:block"></div>
            </div>
        </div>
    </div>

    {{-- ================= ROW 2: Quick Action + Progress & Timeline (KIRI) dan History (KANAN) ================= --}}
