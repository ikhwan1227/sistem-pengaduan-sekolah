...
{{-- Menggunakan grid yang SAMA dengan dashboard-layout (1fr 1fr) --}}
<div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
    {{-- Pesan Sambutan (lebar akan sama dengan Tips & Panduan) --}}
    <div>
    ...
    {{-- Quick Action (lebar akan sama dengan Stats Card) --}}
    <div>
