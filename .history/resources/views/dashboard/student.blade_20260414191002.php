...
<style>
    ...
    .card-header-blue .text-indigo-500 {
        color: white !important;
    }
    .card-header-blue .text-emerald-500 {
        color: white !important;
    }
...
<div class="flex flex-col lg:flex-row gap-4">
    ...
    <div class="flex-1">
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 md:p-5 border border-gray-200 dark:border-gray-700 shadow-sm h-full">
    ...
    {{-- Quick Action (lebar tetap) --}}
    <div class="lg:w-auto w-full lg:max-w-xs">
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl p-2 md:p-3 shadow-md h-full flex items-center justify-between lg:justify-center gap-2">
        <div class="flex items-center gap-1.5">
            <svg class="w-3.5 h-3.5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
            </svg>
            <span class="text-white font-medium text-xs hidden sm:inline">Aksi Cepat</span>
        </div>
        <div class="flex gap-1.5">
            <a href="{{ route('complaint.index') }}" class="px-2.5 py-1 bg-white/20 hover:bg-white/30 rounded-lg text-white text-xs font-medium transition-all duration-200 flex items-center gap-0.5">
                <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                </svg>
                <span class="hidden sm:inline">Buat</span>
            </a>
            <a href="{{ route('complaint.history') }}" class="px-2.5 py-1 bg-white/20 hover:bg-white/30 rounded-lg text-white text-xs font-medium transition-all duration-200 flex items-center gap-0.5">
                <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>
                <span class="hidden sm:inline">Histori</span>
            </a>
            <a href="{{ route('student.tips') }}" class="px-2.5 py-1 bg-white/20 hover:bg-white/30 rounded-lg text-white text-xs font-medium transition-all duration-200 flex items-center gap-0.5">
                <svg class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="dashboard-layout">
        ...
        <div class="dashboard-col" x-data="{
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.2)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.3)] transition-all duration-300 border border-indigo-200 dark:border-indigo-800 overflow-hidden flex flex-col h-full">
                ...
                {{-- Header --}}
                <div class="px-5 py-3 border-b card-header-blue">
                    <div class="flex items-center gap-3">
