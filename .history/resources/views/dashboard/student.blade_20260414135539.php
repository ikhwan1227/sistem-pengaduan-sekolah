...
@section('content')
{{-- Tambahkan style inline untuk memaksa layout --}}
<style>
    .force-side-by-side {
...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="force-side-by-side">
        
        {{-- KIRI: Tips & Panduan --}}
        <div class="force-half">
...
<div class="force-half">
    <div class="grid grid-cols-3 gap-3">
        ...
        <!-- Diproses - col-span-2 (lebih lebar) -->
        <div class="col-span-2 bg-white dark:bg-gray-800 rounded-xl p-3 shadow-[0_4px_20px_rgba(37,99,235,0.15)] hover:shadow-[0_8px_30px_rgba(37,99,235,0.25)] transition-all duration-300 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
    ...
    <div class="force-side-by-side">
        ...
        {{-- KIRI: Quick Action + Progress --}}
        <div class="force-half flex flex-col gap-6">
            <!-- QUICK ACTION -->
