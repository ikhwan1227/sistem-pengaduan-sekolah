...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    {{-- ================= BARIS ATAS: STATS CARD + TIPS CARD (SAMPING KANAN) ================= --}}
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {{-- Kiri: Tips & Panduan (dengan tinggi menyesuaikan) --}}
        <div>
            <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.2)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.3)] transition-all duration-300 border border-indigo-200 dark:border-indigo-800 overflow-hidden h-full">
                ...
                <div class="p-5" x-data="tipsSlider()" x-init="initSlider()">
                    ...
                    <!-- Dots Navigation (lebih besar dan jelas) -->
        ...
        {{-- Kanan: Stats Cards (5 kartu statistik dalam grid 2x3 atau flex wrap) --}}
        <div>
            <div class="flex flex-wrap gap-3 h-full items-stretch">
                <!-- Total -->
    ...
    {{-- ================= LAYOUT 2 KOLOM BAWAH: KIRI (Quick Action + Progress) & KANAN (History) ================= --}}
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        {{-- KOLOM KIRI: Quick Action dan Progress & Timeline ditumpuk vertikal --}}
