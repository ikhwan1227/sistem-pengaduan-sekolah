...
<div class="px-5 py-3 border-t border-indigo-200 dark:border-indigo-800 transition-colors duration-300" :style="'background-color: ' + getFooterBgColor(currentIndex)">
    <div class="flex items-center justify-center gap-3">
        ...
        {{-- Dots Navigation MANUAL (8 dots) - Support Dark Mode --}}
        <div class="flex items-center gap-2">
            <button @click="goToSlide(0)" 
                    class="rounded-full transition-all duration-300 h-2.5"
                    :class="currentIndex === 0 ? 'w-6 bg-blue-600 shadow-sm' : 'w-2.5 bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-400'">
            </button>
            <button @click="goToSlide(1)" 
                    class="rounded-full transition-all duration-300 h-2.5"
                    :class="currentIndex === 1 ? 'w-6 bg-blue-600 shadow-sm' : 'w-2.5 bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-400'">
            </button>
            <button @click="goToSlide(2)" 
                    class="rounded-full transition-all duration-300 h-2.5"
                    :class="currentIndex === 2 ? 'w-6 bg-blue-600 shadow-sm' : 'w-2.5 bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-400'">
            </button>
            <button @click="goToSlide(3)" 
                    class="rounded-full transition-all duration-300 h-2.5"
                    :class="currentIndex === 3 ? 'w-6 bg-blue-600 shadow-sm' : 'w-2.5 bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-400'">
            </button>
            <button @click="goToSlide(4)" 
                    class="rounded-full transition-all duration-300 h-2.5"
                    :class="currentIndex === 4 ? 'w-6 bg-blue-600 shadow-sm' : 'w-2.5 bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-400'">
            </button>
            <button @click="goToSlide(5)" 
                    class="rounded-full transition-all duration-300 h-2.5"
                    :class="currentIndex === 5 ? 'w-6 bg-blue-600 shadow-sm' : 'w-2.5 bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-400'">
            </button>
            <button @click="goToSlide(6)" 
                    class="rounded-full transition-all duration-300 h-2.5"
                    :class="currentIndex === 6 ? 'w-6 bg-blue-600 shadow-sm' : 'w-2.5 bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-400'">
            </button>
            <button @click="goToSlide(7)" 
                    class="rounded-full transition-all duration-300 h-2.5"
                    :class="currentIndex === 7 ? 'w-6 bg-blue-600 shadow-sm' : 'w-2.5 bg-gray-300 dark:bg-gray-500 hover:bg-gray-400 dark:hover:bg-gray-400'">
            </button>
        </div>
