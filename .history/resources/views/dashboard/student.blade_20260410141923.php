...
@section('content')
<div class="space-y-6">
    <!-- Stats Cards - Menderet ke samping dengan ukuran proporsional -->
    ...
    <!-- Tombol Aksi Cepat - Hanya Icon, Label hover -->
    <div class="flex gap-3">
        <a href="{{ route('complaint.index') }}" class="group relative inline-flex items-center justify-center w-10 h-10 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-lg shadow-sm transition-all duration-200">
        ...
        <a href="{{ route('complaint.history') }}" class="group relative inline-flex items-center justify-center w-10 h-10 bg-gray-500 hover:bg-gray-600 text-white rounded-lg shadow-sm transition-all duration-200">
            <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Daftar Pengaduan Terbaru dengan Judul -->
            ...
            @forelse($pengaduanTerbaru as $pengaduan)
                <div class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                    <div class="flex justify-between items-start">
                        ...
                        <a href="{{ route('complaint.history') }}" class="text-blue-600 dark:text-blue-400 text-sm hover:underline ml-4">Detail</a>
                    </div>
                </div>
            @empty
