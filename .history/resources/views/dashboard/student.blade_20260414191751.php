...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
    {{-- Pesan Sambutan (mengambil 3 kolom) --}}
    ...
    {{-- Quick Action (mengambil 1 kolom) --}}
    <div class="lg:col-span-1">
        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl p-3 md:p-4 shadow-md h-full flex items-center justify-between gap-2">
            <div class="flex items-center gap-2">
                <svg class="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span class="text-white font-medium text-sm hidden sm:inline">Aksi</span>
            </div>
