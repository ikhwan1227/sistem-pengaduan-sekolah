...
<div class="space-y-5">
    ...
    {{-- ================= LAYOUT 3 KOLOM (History | Quick Action + Progress) ================= --}}
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-5">
        
        {{-- ================= KOLOM 1: HISTORY PENGAduAN (LEBAR) ================= --}}
        ...
        {{-- ================= KOLOM 2: QUICK ACTION + PROGRESS & TIMELINE ================= --}}
                ...
                <div class="p-4">
                    ...
                    @if($latestComplaint)
                        ...
                        <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400 mb-4">
                            <span class="text-center flex-1">Menunggu</span>
                            <span class="text-center flex-1">Diproses</span>
                            <span class="text-center flex-1">Selesai</span>
                        </div>
