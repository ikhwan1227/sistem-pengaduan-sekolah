...
<div class="flex flex-col lg:flex-row gap-4">
    ...
    {{-- Quick Action (card lebih sempit) --}}
<div class="lg:w-64 w-full">
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl p-3 md:p-4 shadow-md h-full flex items-center justify-between gap-3">
