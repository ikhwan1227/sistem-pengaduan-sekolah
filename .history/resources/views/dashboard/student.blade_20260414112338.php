...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    {{-- ================= CARD DENGAN GAMBAR (Dekoratif) & TANGGAL JAM ================= --}}
    <div class="relative rounded-xl overflow-hidden shadow-[0_8px_30px_rgba(0,0,0,0.15)] mb-8">
        <!-- Background Image dengan gradient overlay -->
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('https://images.unsplash.com/photo-1573164713988-8665fc963095?w=1200&h=400&fit=crop');">
        ...
        <div class="relative px-6 py-8 md:px-8 md:py-10">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="text-white text-xl md:text-2xl font-bold drop-shadow-lg">Informasi Waktu</h3>
                        <p class="text-white/80 text-sm drop-shadow">Waktu saat ini di sistem</p>
                    </div>
                </div>
                
                <div x-data="datetime()" x-init="init()" class="text-center md:text-right">
                    <div class="flex items-center gap-3 bg-white/10 backdrop-blur-md rounded-2xl px-6 py-3 shadow-lg">
                        <div class="text-3xl md:text-4xl font-bold text-white" x-text="date"></div>
                        <div class="flex flex-col">
                            <div class="text-2xl md:text-3xl font-bold text-white font-mono" x-text="time"></div>
                            <div class="text-xs text-white/70" x-text="dayName"></div>
                        </div>
                    </div>
                </div>
            </div>
