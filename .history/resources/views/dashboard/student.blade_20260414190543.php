        ...
        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl p-3 shadow-md h-full">
            <div class="flex items-center justify-between sm:justify-center gap-4">
                ...
                <div class="flex gap-2">
                    <a href="{{ route('complaint.index') }}" class="p-1.5 sm:px-3 sm:py-1.5 bg-white/20 hover:bg-white/30 rounded-lg text-white transition-all duration-200" title="Buat Pengaduan">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                    </a>
                    <a href="{{ route('complaint.history') }}" class="p-1.5 sm:px-3 sm:py-1.5 bg-white/20 hover:bg-white/30 rounded-lg text-white transition-all duration-200" title="Histori">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                        </svg>
                    </a>
                    <a href="{{ route('student.tips') }}" class="p-1.5 sm:px-3 sm:py-1.5 bg-white/20 hover:bg-white/30 rounded-lg text-white transition-all duration-200" title="Tips">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
