    ...
    <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.2)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.3)] transition-all duration-300 border border-indigo-200 dark:border-indigo-800 overflow-hidden flex flex-col h-full">
        ...
        <div class="px-5 py-3 border-t border-indigo-200 dark:border-indigo-800 transition-colors duration-300" :style="'background-color: ' + getFooterBgColor(currentIndex)">
            <div class="flex items-center justify-center gap-3">
                ...
                {{-- Dots Navigation MANUAL (8 dots) --}}
                <div class="flex items-center gap-2">
                    <button @click="goToSlide(0)" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 0 ? 'w-6 bg-[#2563eb]' : 'w-2.5 bg-white'"></button>
                    <button @click="goToSlide(1)" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 1 ? 'w-6 bg-[#2563eb]' : 'w-2.5 bg-white'"></button>
                    <button @click="goToSlide(2)" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 2 ? 'w-6 bg-[#2563eb]' : 'w-2.5 bg-white'"></button>
                    <button @click="goToSlide(3)" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 3 ? 'w-6 bg-[#2563eb]' : 'w-2.5 bg-white'"></button>
                    <button @click="goToSlide(4)" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 4 ? 'w-6 bg-[#2563eb]' : 'w-2.5 bg-white'"></button>
                    <button @click="goToSlide(5)" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 5 ? 'w-6 bg-[#2563eb]' : 'w-2.5 bg-white'"></button>
                    <button @click="goToSlide(6)" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 6 ? 'w-6 bg-[#2563eb]' : 'w-2.5 bg-white'"></button>
                    <button @click="goToSlide(7)" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 7 ? 'w-6 bg-[#2563eb]' : 'w-2.5 bg-white'"></button>
                </div>
