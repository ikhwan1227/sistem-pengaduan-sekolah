...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    {{-- ================= JARAK ANTARA STATS CARD DAN KONTEN BAWAH (ditambah mb-8) ================= --}}
    <div class="mb-8"></div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="flex flex-col gap-6">
            ...
            {{-- CARD TANGGAL DAN WAKTU (dengan tinggi yang sama seperti Tips Card) --}}
            <div class="flex-1">
                <div class="relative rounded-xl overflow-hidden shadow-[0_8px_25px_rgba(37,99,235,0.15)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.25)] transition-all duration-300 border border-gray-200 dark:border-gray-700 h-full bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-700">
                    <!-- Background pattern -->
                    <div class="absolute inset-0 opacity-10">
                        <svg class="w-full h-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
                            <rect fill="white" x="0" y="0" width="100" height="100" />
                            <circle fill="white" cx="50" cy="50" r="40" />
                            <circle fill="none" stroke="white" stroke-width="2" cx="50" cy="50" r="30" />
                    ...
                    <!-- Konten -->
                    <div class="relative px-6 py-8 md:px-8 flex flex-col items-center justify-center min-h-[280px]" x-data="datetime()" x-init="init()">
                        <!-- Icon Jam Besar -->
                        <div class="w-20 h-20 bg-white/20 backdrop-blur-md rounded-2xl flex items-center justify-center shadow-lg mb-4">
                        ...
                        <div class="text-center">
                            <div class="text-4xl md:text-5xl font-bold text-white font-mono tracking-wider mb-2 drop-shadow-lg" x-text="time"></div>
                            <div class="text-2xl md:text-3xl font-bold text-white/90 drop-shadow-lg mb-1" x-text="date"></div>
                            <div class="text-lg text-white/80 drop-shadow-md" x-text="dayName"></div>
                        </div>
                        
                        <!-- Garis dekoratif -->
                        <div class="w-16 h-0.5 bg-white/30 rounded-full my-4"></div>
                        
                        <!-- Info tambahan -->
                        <div class="text-center">
                            <p class="text-white/70 text-sm">Waktu sistem terupdate secara real-time</p>
    ...
    function datetime() {
        return {
            ...
            updateDateTime() {
                ...
                this.dayName = now.toLocaleDateString('id-ID', { weekday: 'long' });
            }
        }
    }
</script>
