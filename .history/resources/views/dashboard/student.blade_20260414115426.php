...
@section('content')
{{-- Tambahan margin horizontal --}}
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    
    {{-- ================= BARIS 1: TIPS & PANDUAN (LEBAR PENUH) ================= --}}
    ...
    {{-- ================= BARIS 2: STATS CARD (LEBAR PENUH) ================= --}}
    ...
    {{-- ================= BARIS 3: LAYOUT 2 KOLOM (Quick Action + Progress & Timeline) dan History ================= --}}
