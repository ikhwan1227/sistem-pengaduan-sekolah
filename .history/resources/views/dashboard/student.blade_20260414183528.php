...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    {{-- ================= PESAN SAMBUTAN ================= --}}
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl p-4 md:p-5 border border-blue-200 dark:border-blue-800">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                @endphp
                <div class="flex items-center gap-2 bg-white/50 dark:bg-gray-800/50 rounded-lg px-3 py-1.5">
                    <div class="w-2 h-2 rounded-full {{ $unreadAlerts > 0 ? 'bg-red-500 animate-pulse' : 'bg-green-500' }}"></div>
                    <span class="text-xs text-gray-600 dark:text-gray-400">
                        @if($unreadAlerts > 0)
                            Anda memiliki {{ $unreadAlerts }} notifikasi belum dibaca
                        @else
