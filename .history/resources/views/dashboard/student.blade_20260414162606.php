...
<div class="px-5 py-3 border-t border-indigo-200 dark:border-indigo-800 transition-colors duration-300" :style="'background-color: ' + getFooterBgColor(currentIndex)">
    <div class="flex items-center justify-center gap-3">
        ...
        <div class="flex items-center gap-2">
            <button @click="currentIndex = 0" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 0 ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'"></button>
            <button @click="currentIndex = 1" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 1 ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'"></button>
            <button @click="currentIndex = 2" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 2 ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'"></button>
            <button @click="currentIndex = 3" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 3 ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'"></button>
            <button @click="currentIndex = 4" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 4 ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'"></button>
            <button @click="currentIndex = 5" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 5 ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'"></button>
            <button @click="currentIndex = 6" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 6 ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'"></button>
            <button @click="currentIndex = 7" class="rounded-full transition-all duration-300 h-2.5" :class="currentIndex === 7 ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2.5 bg-white hover:bg-white/80'"></button>
        </div>
