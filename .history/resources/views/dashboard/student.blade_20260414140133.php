...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="dashboard-layout">
        ...
        <div class="dashboard-col">
            {{-- Menggunakan grid 2 baris (baris 1: 3 card, baris 2: 2 card penuh) --}}
            <div style="display: grid !important; grid-template-columns: repeat(3, 1fr) !important; gap: 0.75rem !important;">
                <!-- Total -->
