...
@section('content')
<div class="space-y-5 px-2 md:px-4">
    ...
    {{-- ================= JARAK ANTARA STATS CARD DAN KONTEN BAWAH ================= --}}
    <div class="mt-8"></div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div class="p-4">
                    <div class="flex gap-3">
                        <a href="{{ route('complaint.index') }}" class="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-white text-sm rounded-lg transition-all duration-200 shadow-md hover:shadow-lg" style="background-color: #2563eb;">
