...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="dashboard-layout">
        ...
        <div class="dashboard-col">
    {{-- Menggunakan grid dengan h-full agar tinggi mengikuti parent --}}
    <div style="display: grid !important; grid-template-columns: repeat(3, 1fr) !important; gap: 0.75rem !important; height: 100% !important; align-content: start !important;">
        <!-- Total -->
