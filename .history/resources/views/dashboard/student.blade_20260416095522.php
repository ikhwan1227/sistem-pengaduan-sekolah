...
<style>
    ...
    /* Equal Height untuk Progress dan History */
...
<main class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="dashboard-grid">
        ...
        <article class="dashboard-col" x-data="{
            tips: [
            ...
            currentIndex: 0,
            intervalId: null,
            initSlider() { this.startAutoSlide(); },
            next() { this.currentIndex = (this.currentIndex + 1) % this.tips.length; this.resetAutoSlide(); },
            prev() { this.currentIndex = (this.currentIndex - 1 + this.tips.length) % this.tips.length; this.resetAutoSlide(); },
            startAutoSlide() { this.intervalId = setInterval(() => { this.next(); }, 5000); },
            resetAutoSlide() { clearInterval(this.intervalId); this.startAutoSlide(); },
            getBodyBgColor(index) { return ['#DBEAFE', '#DCFCE7', '#F3E8FF', '#FFEDD5', '#FCE7F3', '#CCFBF1', '#E0E7FF', '#FEE2E2'][index] || '#F3F4F6'; },
            getFooterBgColor(index) { return ['#BFDBFE', '#BBF7D0', '#E9D5FF', '#FED7AA', '#FBCFE8', '#99F6E4', '#C7D2FE', '#FECACA'][index] || '#E5E7EB'; },
            goToSlide(index) { this.currentIndex = index; this.resetAutoSlide(); }
        }" x-init="initSlider()">
