...
<div class="dashboard-col" x-data="{
    ...
    <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.2)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.3)] transition-all duration-300 border border-indigo-200 dark:border-indigo-800 overflow-hidden flex flex-col h-full">
        ...
        {{-- Footer dengan Panah dan Dots MANUAL --}}
...
<div class="px-5 py-3 border-t border-indigo-200 dark:border-indigo-800 transition-colors duration-300" :style="'background-color: ' + getFooterBgColor(currentIndex)">
    <div class="flex items-center justify-center gap-3">
        {{-- Tombol Prev --}}
        <button @click="prev()" class="w-7 h-7 rounded-full bg-white/90 dark:bg-gray-800 shadow-md flex items-center justify-center hover:scale-110 transition-all duration-300 border border-gray-200 dark:border-gray-600">
        ...
        <div class="flex items-center gap-2">
            <button @click="currentIndex = 0" 
                    ...
                    :class="currentIndex === 0 ? 'w-6 bg-[#2563eb] ring-2 ring-white/50' : 'w-2.5 bg-white/70 hover:bg-white'">
            </button>
            <button @click="currentIndex = 1" 
                    class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
                    :class="currentIndex === 1 ? 'w-6 bg-[#2563eb] ring-2 ring-white/50' : 'w-2.5 bg-white/70 hover:bg-white'">
            </button>
            <button @click="currentIndex = 2" 
                    class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
                    :class="currentIndex === 2 ? 'w-6 bg-[#2563eb] ring-2 ring-white/50' : 'w-2.5 bg-white/70 hover:bg-white'">
            </button>
            <button @click="currentIndex = 3" 
                    class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
                    :class="currentIndex === 3 ? 'w-6 bg-[#2563eb] ring-2 ring-white/50' : 'w-2.5 bg-white/70 hover:bg-white'">
            </button>
            <button @click="currentIndex = 4" 
                    class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
                    :class="currentIndex === 4 ? 'w-6 bg-[#2563eb] ring-2 ring-white/50' : 'w-2.5 bg-white/70 hover:bg-white'">
            </button>
            <button @click="currentIndex = 5" 
                    class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
                    :class="currentIndex === 5 ? 'w-6 bg-[#2563eb] ring-2 ring-white/50' : 'w-2.5 bg-white/70 hover:bg-white'">
            </button>
            <button @click="currentIndex = 6" 
                    class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
                    :class="currentIndex === 6 ? 'w-6 bg-[#2563eb] ring-2 ring-white/50' : 'w-2.5 bg-white/70 hover:bg-white'">
            </button>
            <button @click="currentIndex = 7" 
                    class="rounded-full transition-all duration-300 h-2.5 shadow-sm"
                    :class="currentIndex === 7 ? 'w-6 bg-[#2563eb] ring-2 ring-white/50' : 'w-2.5 bg-white/70 hover:bg-white'">
            </button>
        </div>
        
        {{-- Tombol Next --}}
        <button @click="next()" class="w-7 h-7 rounded-full bg-white/90 dark:bg-gray-800 shadow-md flex items-center justify-center hover:scale-110 transition-all duration-300 border border-gray-200 dark:border-gray-600">
            <svg class="w-3.5 h-3.5 text-gray-600 dark:text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
