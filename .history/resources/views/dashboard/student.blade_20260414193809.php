...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    {{-- Quick Action versi compact --}}
<div class="flex-shrink-0">
    <div class="bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-xl px-4 py-2 md:py-3 shadow-md h-full">
        <div class="flex items-center gap-4">
            <div class="flex items-center gap-2">
                <svg class="w-4 h-4 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <span class="font-medium text-sm text-gray-800 dark:text-white hidden md:inline">Aksi</span>
            </div>
            <div class="flex gap-1">
                <a href="{{ route('complaint.index') }}" class="px-2 py-1 bg-black/10 dark:bg-white/20 hover:bg-black/20 dark:hover:bg-white/30 rounded-lg text-gray-800 dark:text-white text-xs font-medium transition-all duration-200">Buat</a>
                <a href="{{ route('complaint.history') }}" class="px-2 py-1 bg-black/10 dark:bg-white/20 hover:bg-black/20 dark:hover:bg-white/30 rounded-lg text-gray-800 dark:text-white text-xs font-medium transition-all duration-200">Histori</a>
                <a href="{{ route('student.tips') }}" class="px-2 py-1 bg-black/10 dark:bg-white/20 hover:bg-black/20 dark:hover:bg-white/30 rounded-lg text-gray-800 dark:text-white text-xs font-medium transition-all duration-200">Tips</a>
            </div>
        </div>
    </div>
</div>
