...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    {{-- Menggunakan flex dengan pendekatan yang lebih agresif --}}
    <div class="flex flex-nowrap gap-6">
        
        {{-- KIRI: Tips & Panduan (50% lebar, tidak menyusut) --}}
        <div class="w-1/2 flex-shrink-0 min-w-0">
        ...
        {{-- KANAN: Stats Card (50% lebar, tidak menyusut) --}}
        <div class="w-1/2 flex-shrink-0 min-w-0">
            {{-- Menggunakan grid 2 kolom untuk 5 card, hasilnya 2 baris (3 card + 2 card) --}}
    ...
    <div class="flex flex-nowrap gap-6">
        ...
        {{-- KIRI: Quick Action + Progress (50%) --}}
        <div class="w-1/2 flex-shrink-0 min-w-0 flex flex-col gap-6">
            <!-- QUICK ACTION -->
