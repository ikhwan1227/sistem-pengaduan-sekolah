...
<div class="space-y-5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
       ...
       <div>
    <div class="rounded-xl shadow-md border overflow-hidden
                bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500
                dark:from-indigo-900 dark:via-purple-900 dark:to-pink-900">
        
        <!-- Header -->
        <div class="px-5 py-4 border-b border-white/20 bg-white/10 dark:bg-black/20 backdrop-blur-sm">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-white/20 dark:bg-white/10 flex items-center justify-center">
                ...
                <div class="flex transition-transform duration-500 ease-out" :style="'transform: translateX(-' + currentIndex * 100 + '%)'">
                    <template x-for="(tip, index) in tips" :key="index">
                        <div class="w-full flex-shrink-0 px-1">
                            <div class="bg-white/10 dark:bg-black/20 backdrop-blur-sm rounded-xl p-5 border border-white/20 shadow-lg">
        ...
        <!-- Footer -->
        <div class="px-5 py-3 border-t border-white/20 bg-white/5 dark:bg-black/10">
            <div class="flex items-center justify-between">
            ...
            <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-md border border-indigo-200 dark:border-indigo-800 overflow-hidden">
                <div class="px-5 py-4 border-b border-indigo-200 dark:border-indigo-800 bg-white/50 dark:bg-gray-800/30">
                    <div class="flex items-center gap-3">
                ...
                <div class="p-5" x-data="tipsSlider()" x-init="initSlider()">
                    ...
                    <div class="flex justify-center gap-2 mt-5">
                        <template x-for="(tip, index) in tips" :key="index">
                            <button @click="currentIndex = index" 
                                    class="h-1.5 rounded-full transition-all duration-300"
                                    :class="currentIndex === index ? 'w-6 bg-indigo-500' : 'w-1.5 bg-indigo-300 dark:bg-indigo-700'">
                            </button>
                        </template>
                    </div>
