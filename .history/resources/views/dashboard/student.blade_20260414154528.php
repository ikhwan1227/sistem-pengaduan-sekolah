...
<div class="space-y-6 px-4 md:px-6 lg:px-8">
    ...
    <div class="dashboard-layout">
        ...
        <div class="dashboard-col" x-data="tipsSlider()" x-init="initSlider()">
            {{-- Wrapper utama dengan gradien statis --}}
            <div class="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-indigo-950/30 dark:via-purple-950/30 dark:to-pink-950/30 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.2)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.3)] transition-all duration-300 border border-indigo-200 dark:border-indigo-800 overflow-hidden flex flex-col h-full">
                    ...
                    {{-- Content Slider (Body) - Background berganti warna --}}
                    <div class="flex-1 p-5 relative transition-colors duration-300" :class="getBodyBgClass(currentIndex)">
                    ...
                    {{-- Footer dengan Dots - Background berganti warna --}}
                    <div class="px-5 py-3 border-t border-indigo-200 dark:border-indigo-800 transition-colors duration-300" :class="getFooterBgClass(currentIndex)">
                        <div class="flex justify-center items-center gap-2">
                            <template x-for="(tip, index) in tips" :key="index">
                                <button @click="currentIndex = index" 
                                        class="rounded-full transition-all duration-300 h-2"
                                        :class="currentIndex === index ? 'w-6 bg-[#2563eb] shadow-sm' : 'w-2 bg-white/60 hover:bg-white/80'">
                                </button>
                            </template>
                        </div>
                        <div class="text-center mt-2">
                            <span class="text-[10px]" :class="getFooterTextClass(currentIndex)">Tips <span x-text="currentIndex + 1"></span> dari <span x-text="tips.length"></span></span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    function tipsSlider() {
        return {
            ...
            getBodyBgClass(index) {
                const colors = {
                    0: 'bg-blue-100 dark:bg-blue-950/30',
                    1: 'bg-green-100 dark:bg-green-950/30',
                    2: 'bg-purple-100 dark:bg-purple-950/30',
                    3: 'bg-orange-100 dark:bg-orange-950/30',
                    4: 'bg-pink-100 dark:bg-pink-950/30',
                    5: 'bg-teal-100 dark:bg-teal-950/30',
                    6: 'bg-indigo-100 dark:bg-indigo-950/30',
                    7: 'bg-red-100 dark:bg-red-950/30'
                };
                return colors[index] || 'bg-gray-100 dark:bg-gray-800/50';
            },
            
            getFooterBgClass(index) {
                const colors = {
                    0: 'bg-blue-200/50 dark:bg-blue-900/30',
                    1: 'bg-green-200/50 dark:bg-green-900/30',
                    2: 'bg-purple-200/50 dark:bg-purple-900/30',
                    3: 'bg-orange-200/50 dark:bg-orange-900/30',
                    4: 'bg-pink-200/50 dark:bg-pink-900/30',
                    5: 'bg-teal-200/50 dark:bg-teal-900/30',
                    6: 'bg-indigo-200/50 dark:bg-indigo-900/30',
                    7: 'bg-red-200/50 dark:bg-red-900/30'
                };
                return colors[index] || 'bg-gray-200/50 dark:bg-gray-800/30';
            },
            
            getFooterTextClass(index) {
                const colors = {
                    ...
                    4: 'text-pink-700 dark:text-pink-300',
                    5: 'text-teal-700 dark:text-teal-300',
                    6: 'text-indigo-700 dark:text-indigo-300',
