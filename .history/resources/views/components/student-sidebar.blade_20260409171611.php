...
<div x-data="{ sidebarOpen: true }" 
    ...
    <!-- Tips Ringkas di Sidebar Bottom (ketika sidebar terbuka) -->
    <div x-show="sidebarOpen" class="mx-3 mb-4 p-3 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
        ...
        <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">
            Deskripsikan masalah dengan detail dan sertakan foto agar cepat ditindaklanjuti.
        </p>
    </div>
