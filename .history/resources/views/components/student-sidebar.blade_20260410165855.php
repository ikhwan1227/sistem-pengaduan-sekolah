...
<div id="sidebar" class="w-48 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col flex-shrink-0 h-screen sticky top-0">
    ...
    <!-- Tips -->
    <div class="mx-2 mb-2 p-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
        <p class="text-xs font-semibold text-blue-600 dark:text-blue-400">💡 Tips Cepat</p>
        <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Deskripsikan masalah dengan detail agar cepat ditindaklanjuti.</p>
    </div>
    ...
    <div class="p-3 border-t border-gray-200 dark:border-gray-700">
        <div class="flex items-center space-x-2">
            ...
            <div class="flex-1">
                <p class="text-xs font-medium text-gray-700 dark:text-gray-300 truncate">{{ auth()->user()->name }}</p>
