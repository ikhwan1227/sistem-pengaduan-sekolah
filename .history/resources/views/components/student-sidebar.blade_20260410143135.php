...
<div x-data="app()" 
    ...
    <!-- Menu Items - Scrollable tapi tidak terlalu tinggi -->
    <nav class="flex-1 mt-3 px-1.5 space-y-0.5 overflow-y-auto" style="max-height: calc(100vh - 180px);">
