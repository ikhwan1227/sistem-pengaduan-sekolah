        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
            @forelse($complaints as $c)
                <div class="p-5 hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-all duration-200">
                    ...
                    @if($c->image)
                        <div class="mb-3">
                            <img src="{{ asset('storage/' . $c->image) }}" 
                                 class="rounded-lg border border-gray-200 dark:border-gray-600 max-h-32 object-cover"
                    ...
                    @if($c->feedbacks->count() > 0)
                        <div class="mt-3 bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border-l-4 border-green-500">
                            <div class="flex items-start gap-2">
                                ...
                                <div class="flex-1">
                                    <span class="text-xs font-semibold text-green-700 dark:text-green-400">Balasan Admin:</span>
                    ...
                    {{-- Tombol Detail --}}
                    <div class="mt-4">
                        <a href="{{ route('complaint.history') }}?id={{ $c->id }}" 
                           class="inline-flex items-center gap-1 text-sm text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 font-medium transition-colors duration-200">
                            Detail Pengaduan
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
