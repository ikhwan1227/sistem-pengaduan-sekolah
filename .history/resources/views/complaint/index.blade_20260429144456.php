...
<div x-show="activeTab === 'draft'" x-cloak>
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-600 to-gray-700">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-lg font-bold text-white">Draft Pengaduan</h2>
                        <p class="text-xs text-gray-200">Pengaduan yang belum dikirim</p>
                    </div>
                </div>
                <div class="bg-white/20 rounded-full px-3 py-1">
                    <span class="text-sm font-semibold text-white">{{ isset($drafts) ? $drafts->count() : 0 }}</span>
                    <span class="text-xs text-white/80"> draft</span>
                </div>
            </div>
        </div>
        ...
        <div class="divide-y divide-gray-200 dark:divide-gray-700">
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-300 mb-2">Belum Ada Draft</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400 mb-4">Anda belum memiliki draft pengaduan</p>
            ...
            @forelse($complaints as $c)
                <div class="p-5">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-3">
                        ...
                        <div class="flex justify-start">
                            @if($c->image)
                                <img src="{{ asset('storage/' . $c->image) }}" 
                                    class="rounded-lg border border-gray-200 dark:border-gray-600 max-w-full h-20 w-auto object-contain"
                                    alt="Gambar pengaduan">
                            @else
                                <div class="w-32 h-20 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-600">
                        ...
                        {{-- Kolom Kanan: Pesan Admin / Balasan --}}
                        <div>
                            @if($c->feedbacks->count() > 0)
                                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-2 h-28 overflow-y-auto">
                            ...
                            @else
                                <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-2 h-28 flex items-center justify-center">
