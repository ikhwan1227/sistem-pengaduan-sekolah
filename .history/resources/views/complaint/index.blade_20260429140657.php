...
<div>
    @if($c->image)
        <img src="{{ asset('storage/' . $c->image) }}" 
             class="w-full rounded-lg border border-gray-200 dark:border-gray-600 h-20 object-cover"
             alt="Gambar pengaduan">
    @else
        <div class="w-full h-20 bg-gray-100 dark:bg-gray-700 rounded-lg flex items-center justify-center border border-gray-200 dark:border-gray-600">
