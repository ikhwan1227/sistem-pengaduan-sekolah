...
<div x-show="activeTab === 'buat'" x-cloak>
    <div class="flex justify-center">
        <div class="w-full max-w-6xl">
            {{-- Gunakan flex dengan md:flex-row --}}
                        ...
                        <div class="p-6">
                            <form method="POST" action="{{ isset($draft) ? route('complaint.store') : route('complaint.store') }}" enctype="multipart/form-data" id="complaintForm">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="deskripsi" placeholder="Jelaskan pengaduan secara detail..." rows="6"
                                ...
                                <div class="mb-6">
                                    ...
                                    <div x-data="fileUpload()" x-init="init()" class="w-full">
                                        <label for="image-upload" 
                                               class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-xl cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-200"
                                               :class="isDragging ? 'border-blue-500 bg-blue-50 dark:bg-blue-900/20' : ''"
                                               @dragover.prevent="isDragging = true"
                                               @dragleave.prevent="isDragging = false"
                                               @drop.prevent="handleDrop($event)">
                                            
                                            <div class="flex flex-col items-center justify-center pt-5 pb-6" x-show="!filePreview && !fileName">
                                            ...
                                            <div x-show="filePreview" class="relative w-full h-full flex flex-col items-center justify-center">
                                                <img :src="filePreview" class="max-h-24 rounded-lg shadow-sm object-contain">
                                            ...
                                            <div x-show="fileName && !filePreview" class="flex flex-col items-center justify-center">
                                                <svg class="w-8 h-8 mb-1 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
