...
<div x-show="activeTab === 'histori'" x-cloak>
    <div class="space-y-3">
        @forelse($complaints as $c)
            <article class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-all duration-200">
                {{-- Header: Judul dan Status sejajar --}}
                <div class="px-4 py-3 border-b border-gray-100 dark:border-gray-700 flex justify-between items-center">
                    <h3 class="font-semibold text-gray-800 dark:text-white">{{ $c->judul }}</h3>
                ...
                <div class="px-4 py-2 border-b border-gray-100 dark:border-gray-700 flex flex-wrap items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                ...
                {{-- Deskripsi --}}
                <div class="px-4 py-3">
                    <p class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">{{ $c->deskripsi }}</p>
                </div>
                
                {{-- Gambar dan Balasan Admin (SAMPINGAN / FLEX ROW) --}}
                <div class="px-4 pb-4 flex flex-row items-start gap-4">
                    {{-- Gambar --}}
                    @if($c->image)
                        <div class="flex-shrink-0">
                            <img src="{{ asset('storage/' . $c->image) }}" class="w-20 h-20 object-cover rounded-lg shadow-sm border border-gray-200 dark:border-gray-600">
                        </div>
                    @endif
                    
                    {{-- Balasan Admin (di samping gambar) --}}
                        ...
                        <div class="flex-1">
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-3 border-l-4 border-green-500">
                                <div class="flex items-center gap-2 mb-1">
                                    ...
                                    <h4 class="text-sm font-semibold text-green-700 dark:text-green-400">Balasan Admin</h4>
                                </div>
                                @foreach($c->feedbacks as $f)
                                    <p class="text-sm text-green-700 dark:text-green-300">{{ $f->pesan }}</p>
                                @endforeach
                            </div>
                        </div>
                    @endif
        ...
        @empty
            <div class="text-center py-12 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
                ...
                <button @click="activeTab = 'buat'" class="inline-block mt-4 px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-sm font-medium rounded-lg hover:shadow-lg transition-all duration-200">
                    + Buat Pengaduan Sekarang
                </button>
            </div>
        @endforelse
