    ...
    <div class="space-y-3">
        @forelse($complaints as $c)
            <article class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-all duration-200">
                ...
                <div class="px-4 py-2 border-b border-gray-100 dark:border-gray-700 flex flex-wrap items-center gap-3 text-xs text-gray-500 dark:text-gray-400">
                ...
                {{-- Baris 4: Gambar + Balasan Admin (SAMPINGAN) --}}
                <div class="px-4 pb-4 flex flex-row flex-wrap items-start gap-4">
                    @if($c->image)
                        <div>
