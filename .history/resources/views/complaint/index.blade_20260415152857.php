...
<div x-show="activeTab === 'buat'" x-cloak>
    <div class="flex flex-wrap lg:flex-nowrap gap-6">
        ...
        {{-- KOLOM KANAN: Card Informasi Pengaduan --}}
        <div class="w-full lg:w-1/3">
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl border border-blue-200 dark:border-blue-800 overflow-hidden lg:sticky lg:top-24">
