            ...
            <form method="POST" action="{{ isset($draft) ? route('complaint.store') : route('complaint.store') }}" enctype="multipart/form-data" id="complaintForm">
                ...
                <div class="mb-6">
                    ...
                    <div x-data="fileUpload()" x-init="init()" class="w-full">
                        <label for="image-upload" 
                               class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-xl cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-all duration-200"
                            ...
                            <div x-show="filePreview" class="relative w-full h-full flex flex-col items-center justify-center">
                                <img :src="filePreview" class="max-h-32 rounded-lg shadow-sm object-contain">
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-2" x-text="fileName"></p>
                            ...
                            <div x-show="fileName && !filePreview" class="flex flex-col items-center justify-center">
                                ...
                                <button type="button" @click="removeFile()" class="mt-2 text-xs text-red-500 hover:text-red-600">Hapus</button>
                            </div>
                ...
                <div class="flex flex-col sm:flex-row justify-end gap-3 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button type="submit" name="action" value="draft" formaction="{{ route('complaint.draft') }}" 
                            class="px-6 py-2.5 bg-gray-500 hover:bg-gray-600 text-white font-medium rounded-lg shadow-sm transition-all duration-200 flex items-center justify-center gap-2">
                        <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-3m-1 4l-3 3m0 0l-3-3m3 3V4" />
                        </svg>
                        Simpan ke Draft
