...
<div x-show="activeTab === 'histori'" x-cloak>
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-[0_8px_25px_rgba(37,99,235,0.15)] hover:shadow-[0_12px_35px_rgba(37,99,235,0.25)] transition-all duration-300 border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-4" style="overflow-x: auto; white-space: nowrap; scrollbar-width: thin;">
            <div class="d-flex" style="display: flex; gap: 1rem; flex-wrap: nowrap;">
                @forelse($complaints as $c)
                    {{-- Card Pengaduan --}}
                    <div class="card" style="flex: 0 0 320px; min-width: 320px; background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.08); transition: all 0.3s ease; white-space: normal; display: inline-block;">
                        ...
                        <div class="p-3" style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-bottom: 1px solid #e5e7eb;">
                            <div class="d-flex" style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 8px;">
                                <h3 class="font-semibold" style="font-size: 14px; color: #1f2937; margin: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; max-width: 180px;">
                                    {{ $c->judul }}
                                </h3>
                            ...
                            <div class="d-flex" style="display: flex; align-items: center; gap: 12px; font-size: 11px; color: #6b7280;">
                        ...
                        <div class="p-3" style="min-height: 160px;">
                            {{-- Gambar --}}
                            @if($c->image)
                                <div class="mb-2" style="width: 100%; height: 120px; overflow: hidden; border-radius: 8px;">
                                    <img src="{{ asset('storage/' . $c->image) }}" 
                                         style="width: 100%; height: 100%; object-fit: cover;"
                                         onerror="this.src='https://placehold.co/400x200?text=No+Image'">
                                </div>
                            @else
                                <div class="mb-2" style="width: 100%; height: 120px; background: #f3f4f6; border-radius: 8px; display: flex; align-items: center; justify-content: center;">
                            ...
                            {{-- Deskripsi --}}
                            <p class="text-sm" style="color: #4b5563; margin: 8px 0 0 0; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; line-height: 1.4;">
                                {{ Str::limit($c->deskripsi, 100) }}
                            </p>
                            
                            {{-- Lokasi --}}
                            @if($c->location)
                                <p class="text-xs" style="color: #9ca3af; margin-top: 6px; display: flex; align-items: center; gap: 4px;">
                        ...
                        @if($c->feedbacks->count() > 0)
                            <div class="p-3" style="background: #f0fdf4; border-top: 1px solid #dcfce7; border-bottom: 1px solid #dcfce7;">
                                <div class="d-flex" style="display: flex; align-items: start; gap: 6px;">
