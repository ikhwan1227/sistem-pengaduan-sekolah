...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    {{-- ================= HERO SECTION: STATS CARD (KIRI) + WELCOME CARD (KANAN) ================= --}}
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        
        {{-- KOLOM KIRI: 6 STATS CARD (2 baris x 3 kolom) --}}
        <div class="lg:col-span-2">
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                <!-- Total -->
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Total Pengaduan</p>
                            <p class="text-2xl font-bold text-gray-800 dark:text-white mt-1">{{ $totalAll ?? 0 }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Bulan Ini</p>
                            <p class="text-2xl font-bold text-gray-800 dark:text-white mt-1">{{ $totalBulanIni ?? 0 }}</p>
                            <p class="text-[10px] text-gray-400 dark:text-gray-500 mt-1">{{ now()->format('F Y') }}</p>
                        </div>
                        <div class="w-10 h-10 bg-emerald-100 dark:bg-emerald-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Menunggu</p>
                            <p class="text-2xl font-bold text-amber-600 dark:text-amber-400 mt-1">{{ $totalPending ?? 0 }}</p>
                            <p class="text-[10px] text-gray-400 dark:text-gray-500 mt-1">Pending</p>
                        </div>
                        <div class="w-10 h-10 bg-amber-100 dark:bg-amber-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Diproses</p>
                            <p class="text-2xl font-bold text-sky-600 dark:text-sky-400 mt-1">{{ $totalDiproses ?? 0 }}</p>
                            <p class="text-[10px] text-gray-400 dark:text-gray-500 mt-1">Sedang ditangani</p>
                        </div>
                        <div class="w-10 h-10 bg-sky-100 dark:bg-sky-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Selesai</p>
                            <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">{{ $totalSelesai ?? 0 }}</p>
                            <p class="text-[10px] text-gray-400 dark:text-gray-500 mt-1">Telah selesai</p>
                        </div>
                        <div class="w-10 h-10 bg-green-100 dark:bg-green-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Ditolak</p>
                            <p class="text-2xl font-bold text-rose-600 dark:text-rose-400 mt-1">{{ $totalDitolak ?? 0 }}</p>
                            <p class="text-[10px] text-gray-400 dark:text-gray-500 mt-1">Tidak diproses</p>
                        </div>
                        <div class="w-10 h-10 bg-rose-100 dark:bg-rose-900/30 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-800 dark:to-indigo-900 rounded-2xl shadow-lg p-6 h-full flex flex-col justify-center">
            <div class="flex items-center gap-4 mb-4">
                ...
                <div>
                    ...
                    <p class="text-blue-100 text-sm">Selamat datang, {{ auth()->user()->name ?? 'Admin' }}</p>
                </div>
            </div>
            
            {{-- Hanya menampilkan tanggal terkini di bawah garis --}}
            ...
            .catch(error => {
                ...
                contentDiv.innerHTML = `
                    <div class="text-center py-8 text-red-500">
                        ...
                        <button onclick="closeDetailModal()" class="mt-2 px-3 py-1 bg-blue-500 text-white rounded text-sm">Tutup</button>
                    </div>
                `;
            });
    }
            ...
            <div class="space-y-4">
                ...
                <div class="border-t border-gray-200 dark:border-gray-700 pt-3">
                    <div class="flex items-center gap-1 mb-2">
                        ...
                        <span class="text-xs font-semibold text-gray-600 dark:text-gray-400">Update Status & Feedback</span>
                    </div>
                    
                    <form method="POST" action="/admin/status-feedback/${complaint.id}" class="space-y-3" id="combinedForm-${complaint.id}">
                        @csrf
                        
                        {{-- Pilihan Status --}}
                        <div>
                            <label class="text-xs text-gray-500 dark:text-gray-400 mb-1 block">Status Pengaduan</label>
                            <select name="status" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md p-2 text-sm focus:ring-1 focus:ring-blue-500">
                        ...
                        {{-- Input Feedback --}}
                        <div>
                            <label class="text-xs text-gray-500 dark:text-gray-400 mb-1 block">Feedback untuk Siswa</label>
                            <textarea name="pesan" rows="2" class="w-full border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md p-2 text-sm focus:ring-1 focus:ring-blue-500" placeholder="Tulis feedback untuk siswa..."></textarea>
                            <p class="text-[10px] text-gray-400 mt-1">Opsional: bisa dikosongkan jika tidak perlu feedback</p>
                        </div>
                        
                        {{-- Tombol Kirim (satu tombol untuk semua) --}}
                        <button type="submit" class="w-full px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-md text-sm font-medium transition flex items-center justify-center gap-2">
                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
