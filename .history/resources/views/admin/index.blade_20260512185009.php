        ...
        <div class="lg:col-span-1">
            <div class="bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-800 dark:to-indigo-900 rounded-2xl shadow-lg p-6 h-full flex flex-col justify-center">
                ...
                <div class="border-t border-white/20 pt-4 mt-2">
                    <p class="text-white/80 text-sm">📊 Kelola dan pantau semua pengaduan siswa dengan mudah.</p>
                    <p class="text-white/60 text-xs mt-2">Total pengaduan: <span class="font-semibold text-white">{{ $totalAll ?? 0 }}</span></p>
                </div>
            </div>
        </div>
    </div>
