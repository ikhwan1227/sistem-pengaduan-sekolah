...
<div class="max-w-6xl mx-auto mt-10">
    ...
    <div class="border rounded p-4 mb-4 shadow">
        ...
        <div class="mt-3 flex flex-wrap gap-2">
            ...
            <!-- FEEDBACK -->
            <form method="POST" action="/feedback/{{ $c->id }}" class="flex gap-1">
                @csrf
                <input type="text" name="pesan" placeholder="Feedback..." class="border p-1 rounded">
                <button class="bg-purple-500 text-white px-3 py-1 rounded">Kirim</button>
            </form>
