...
<div class="max-w-7xl mx-auto mt-6 px-4 sm:px-6 lg:px-8">
    ...
    @php
        ...
        // $totalBulanIni SUDAH DIKIRIM DARI CONTROLLER, tidak perlu dihitung ulang
    @endphp

    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-6">
        <!-- Total Semua -->
        <div class="bg-white dark:bg-gray-800 rounded-xl p-3 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-200">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-3 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-red-600 dark:text-red-400">{{ $complaints->where('status', 'ditolak')->count() }}</p>
                </div>
