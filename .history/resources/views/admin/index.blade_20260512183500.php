...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
    ...
    {{-- ================= WELCOME CARD (Card Besar) ================= --}}
    <div class="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 rounded-2xl shadow-xl mb-8 overflow-hidden relative">
        {{-- Background decoration --}}
        <div class="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -mr-32 -mt-32"></div>
        <div class="absolute bottom-0 left-0 w-48 h-48 bg-white/5 rounded-full -ml-24 -mb-24"></div>
        <div class="absolute top-1/2 left-1/2 w-96 h-96 bg-white/5 rounded-full -translate-x-1/2 -translate-y-1/2"></div>
                ...
                <div class="flex items-center gap-3">
                    <div class="bg-white/20 backdrop-blur-sm rounded-xl px-4 py-2">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-white">{{ now()->format('l, d F Y') }}</span>
                        </div>
                    </div>
                    <div class="bg-white/20 backdrop-blur-sm rounded-xl px-4 py-2">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-sm text-white">Total: {{ $totalAll ?? 0 }} Pengaduan</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
            ...
            <p class="text-xs font-semibold text-gray-600 dark:text-gray-400">Total Pengaduan</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
            ...
            <p class="text-xs font-semibold text-gray-600 dark:text-gray-400">Bulan Ini</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
            ...
            <p class="text-xs font-semibold text-gray-600 dark:text-gray-400">Menunggu</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
            ...
            <p class="text-xs font-semibold text-gray-600 dark:text-gray-400">Diproses</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
            ...
            <p class="text-xs font-semibold text-gray-600 dark:text-gray-400">Selesai</p>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700 group">
            ...
            <p class="text-xs font-semibold text-gray-600 dark:text-gray-400">Ditolak</p>
