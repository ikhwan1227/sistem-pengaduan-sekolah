<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="{ darkMode: localStorage.getItem('darkMode') === 'false' || localStorage.getItem('darkMode') === null ? false : true }" x-init="$watch('darkMode', val => localStorage.setItem('darkMode', val))" :class="{ 'dark': darkMode }">
<head>
    <meta charset="utf-8">
...
<body class="font-sans antialiased bg-gray-100 dark:bg-gray-900 transition-colors duration-200 overflow-hidden">
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-end h-16">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <!-- User Dropdown - Hanya Icon, tanpa panah -->
