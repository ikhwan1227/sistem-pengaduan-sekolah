<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" x-data="{ darkMode: false }" x-init="darkMode = localStorage.getItem('darkMode') === 'true'; $watch('darkMode', val => { localStorage.setItem('darkMode', val); document.documentElement.classList.toggle('dark', val); })" x-bind:class="{ 'dark': darkMode }">
<head>
    <meta charset="utf-8">
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-end h-14">
                        ...
                        <div class="flex items-center space-x-2">
                            <!-- Dark Mode Toggle - Dengan event click yang jelas -->
                            <button @click="darkMode = !darkMode; $event.stopPropagation()" 
