            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="flex items-center justify-between h-14">
                    ...
                    <div class="hidden md:flex items-center space-x-1">
                        ...
                        <a href="{{ route('complaint.history') }}" 
                           class="px-3 py-2 rounded-lg text-sm font-medium transition-colors duration-200
                                  {{ request()->routeIs('complaint.history') 
                                      ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400' 
                                      : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                            <svg class="w-4 h-4 inline mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="md:hidden border-t border-gray-200 dark:border-gray-700 py-2">
                    <div class="flex flex-wrap gap-1">
                        ...
                        <a href="{{ route('complaint.history') }}" class="px-2 py-1.5 rounded-lg text-xs font-medium transition-colors duration-200 {{ request()->routeIs('complaint.history') ? 'bg-blue-50 dark:bg-blue-900/50 text-blue-600 dark:text-blue-400' : 'text-gray-600 dark:text-gray-400' }}">
                            Histori
                        </a>
