...
<head>
    ...
    <style>
        ...
        .sidebar-closed .sidebar-tips {
            display: none;
        }
        .sidebar-closed .sidebar-user-text {
            display: none;
        }
        .sidebar-open {
            width: 13rem;
        ...
        <div class="flex-1 flex flex-col min-h-screen">
                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-end h-14">
                        ...
                        <div class="flex items-center space-x-2">
                            <!-- Dark Mode Toggle -->
                            <button id="darkModeToggle" class="p-2 rounded-lg text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
            ...
            <main class="flex-1 p-4 lg:p-6 overflow-y-auto">
                <div class="max-w-7xl mx-auto">
                    @if(session('success'))
                        <div class="mb-4 bg-green-100 dark:bg-green-800 border-l-4 border-green-500 text-green-700 dark:text-green-200 p-4 rounded shadow">
