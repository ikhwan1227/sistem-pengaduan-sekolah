...
class AdminController extends Controller
{
    ...
    /**
     * Update status dan kirim feedback sekaligus
     */
    public function updateStatusAndFeedback(Request $request, $id)
    {
        ...
        // Jika ada pesan feedback, simpan
        if ($request->filled('pesan')) {
            ...
            // Kirim notifikasi feedback
            $complaint->user->notify(new NewFeedback($complaint, $feedback));
        }

        return back()->with('success', 'Status dan feedback berhasil dikirim!');
    }
